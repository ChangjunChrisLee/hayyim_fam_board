...
export default function MemberCard({
  ...
  return (
    <div
      className="rounded-3xl overflow-hidden shadow-card hover:shadow-soft-lg transition-shadow"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 mt-0.5">
            {completedCount}/{goals.length}개 완료
          </p>
        </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      ...
                      style={{
                        backgroundColor: done ? 'rgba(255,255,255,0.5)' : member.bgColor,
                        color: member.color,
                      }}
                    >
                      {goal.category}
